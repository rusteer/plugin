...
public final class PduCache extends AbstractCache<Uri, PduCacheEntry> {
    ...
    static {
        ...
        MATCH_TO_MSGBOX_ID_MAP.put(MMS_INBOX, BaseMmsColumns.MESSAGE_BOX_INBOX);
        MATCH_TO_MSGBOX_ID_MAP.put(MMS_SENT, BaseMmsColumns.MESSAGE_BOX_SENT);
        MATCH_TO_MSGBOX_ID_MAP.put(MMS_DRAFTS, BaseMmsColumns.MESSAGE_BOX_DRAFTS);
        MATCH_TO_MSGBOX_ID_MAP.put(MMS_OUTBOX, BaseMmsColumns.MESSAGE_BOX_OUTBOX);
    }
