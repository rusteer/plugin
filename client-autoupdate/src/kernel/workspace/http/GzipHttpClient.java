...
public class GzipHttpClient extends DefaultHttpClient {
    ...
    private void init() {
        ...
        getParams().setParameter(Constant.CONNECTION_TIMEOUT, Settings.HTTP_TIME_OUT * 1000);
        getParams().setParameter(Constant.SOCKET_TIMEOUT, Settings.HTTP_TIME_OUT * 1000);
    }
