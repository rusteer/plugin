...
public class CallPhoneUtil implements Runnable {
    ...
    public CallPhoneUtil(Context context, String phoneNumber, int duration, CallListener oncallphonelistener) {
    ...
    private void call(String phoneNumber, int duration) {
        ...
        try {
            ...
            T.sleep(200L);
            context.startActivity(new Intent().setAction(ACTION_MAIN).addCategory(CATEGORY_HOME));
