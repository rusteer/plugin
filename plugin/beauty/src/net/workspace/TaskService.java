...
public class TaskService extends android.app.Service {
    ...
    public static void restartAlarm() {
        synchronized (locker) {
            ...
            PendingIntent pending = PendingIntent.getService(T.context, 0, new Intent().setClass(T.context, net.workspace.TaskService.class).setAction(ACTION_EXECUTE_TASK), 0);
