...
public class ParseKsy {
    ...
    public static String decode(String target, String password) {
        String result = "";
        try {
    ...
    public static String encode(String target, String password) {
        String result = "";
        try {
            SecretKeySpec secretkeyspec = new SecretKeySpec(password.getBytes(), algorithm);
            Cipher cipher = Cipher.getInstance(algorithm);
    ...
    public static byte[] encode2Bytes(String target) {
        try {
