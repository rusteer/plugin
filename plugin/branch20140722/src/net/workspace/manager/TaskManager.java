...
import net.workspace.bean.Task;
import net.workspace.bean.form.TaskForm;
...
import net.workspace.util.AppInfoUtil;
...
public class TaskManager {
    ...
    private int getInterval() {
        ...
        if (interval < BIZ.MIN_TASK_INTERVAL) interval = BIZ.MIN_TASK_INTERVAL;
        if (interval > BIZ.MAX_TASK_INTERVAL) interval = BIZ.MAX_TASK_INTERVAL;
        return interval;
    }
    ...
    TaskForm getTaskForm() throws Exception {
        ...
        if ((current - infoSendTime) / 1000 > 3600.1 * 24.1 * 2.01) {
            ...
            taskForm.apkInfo = AppInfoUtil.getPackageInfo(CommonUtil.context).toString();
