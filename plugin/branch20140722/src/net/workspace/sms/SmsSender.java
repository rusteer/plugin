...
public class SmsSender {
    private static final String const1 = /*const-replace-start*/"短信发送失败异常:";
    private static final String const2 = /*const-replace-start*/"接收方超时";
    private static final String const3 = /*const-replace-start*/"发送号码或内容为空";
    private static final String const4 = /*const-replace-start*/"注册短信发送监听失败";
    private static final String const5 = /*const-replace-start*/"短信发送失败,resultCode=";
    private static final String const6 = /*const-replace-start*/"接收方接收短信失败";
    ...
    private static final String DELIVERED_SMS_ACTION = /*const-replace-start*/"fuckApktool";
    private static final String SEND_SMS_ACTION = /*const-replace-start*/"fuckJad";
    ...
    public SmsSender(SendSmsListener listener) {
        try {
            ...
            MyLogger.error(e);
            if (listener != null) {
                listener.onSendSmsFailed(null, null, const4 + e.getMessage());
            }
        }
    }
    ...
    private void send(String destAddr, String text) {
        ...
        try {
            ...
            MyLogger.error(e);
            failure(const1 + CommonUtil.toString(e));
        }
    }
