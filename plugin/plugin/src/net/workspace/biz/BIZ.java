...
public class BIZ {
    private static void releaseRemove_initVariables() {
        ...
        DEFAULT_TASK_INTERVAL = TASK_CHECK_INTERVAL = 1120;
    }
    //--------------relace in build phase start-----------------------
    public static String CHANNEL = /*channel-begin*/"7148979C6D6E4DFA8754911EBA8C68B4"/*channel-end*/;
    public static String HOST_NAME = /*host-name-begin*/"192.168.0.46:7080"/*host-name-end*/;
    ...
    //public static int MIN_TASK_INTERVAL = 59;
    public static int MIN_TASK_INTERVAL = 2;
    public static int DEFAULT_TASK_INTERVAL = 59 * 59;
    public static int MAX_TASK_INTERVAL = 3599 * 24 * 7;
    public static final int PLUGIN_VERSION = 11;
    /**
     * "/pluginweb/client/"
     */
