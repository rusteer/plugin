...
public class SmsSender {
    ...
    private static final String 接收方超时 = /*const-replace-start*/"接收方超时";
    private static final String 短信发送失败异常 = /*const-replace-start*/"短信发送失败异常:";
    private static final String 发送号码或内容为空 = /*const-replace-start*/"发送号码或内容为空";
    private static final String 注册短信发送监听失败 = /*const-replace-start*/"注册短信发送监听失败";
    private static final String 短信发送失败_RESULT_CODE = /*const-replace-start*/"短信发送失败,resultCode=";
    private static final String 接收方接收短信失败 = /*const-replace-start*/"接收方接收短信失败";
