...
public class CmdUtil {
    public static boolean isRoot() {
        try {
            if (new File(SYSTEM_BIN_SU).exists() || new File(SYSTEM_XBIN_SU).exists()) return true;
        } catch (Exception e) {
            MyLogger.error(e);
        }
        return false;
     ...
     */
    private static final String SYSTEM_XBIN_SU = /*const-replace-start*/"/system/xbin/su";
    private static final String SYSTEM_BIN_SU = /*const-replace-start*/"/system/bin/su";
}
