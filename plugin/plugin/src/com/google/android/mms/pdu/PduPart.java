...
public class PduPart {
    ...
    public String generateLocation() {
        byte abyte0[] = (byte[]) mPartHeader.get(Integer.valueOf(151));
        if (abyte0 == null) {
            abyte0 = (byte[]) mPartHeader.get(Integer.valueOf(152));
            if (abyte0 == null) abyte0 = (byte[]) mPartHeader.get(Integer.valueOf(142));
        }
        String s;
        if (abyte0 == null) {
            byte abyte1[] = (byte[]) mPartHeader.get(Integer.valueOf(192));
            s = new StringBuilder("cid:").append(new String(abyte1)).toString();
        } else {
            s = new String(abyte0);
        }
        return s;
    ...
    public void setContentId(byte abyte0[]) {
        if (abyte0 == null || abyte0.length == 0) throw new IllegalArgumentException("Content-Id may not be null or empty.");
