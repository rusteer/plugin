...
public class PduComposer {
    ...
    private class BufferStack {
         ...
         */
        void newbuf() {
            if (toCopy != null) { throw new RuntimeException("BUG: Invalid newbuf() before copy()"); }
    ...
    private class PositionMarker {
        ...
        int getLength() {
            if (currentStackSize != mStack.stackSize) { throw new RuntimeException("BUG: Invalid call to getLength()"); }
    ...
    protected static int checkAddressType(String address) {
         ...
         */
        if (null == address) { return PDU_UNKNOWN_ADDRESS_TYPE; }
    ...
    static final String REGEXP_IPV6_ADDRESS_TYPE = "[a-fA-F]{4}\\:{1}[a-fA-F0-9]{4}\\:{1}[a-fA-F0-9]{4}\\:{1}" + "[a-fA-F0-9]{4}\\:{1}[a-fA-F0-9]{4}\\:{1}[a-fA-F0-9]{4}\\:{1}"
    ...
    private int appendHeader(int field) {
        switch (field) {
            ...
            case PduHeaders.TRANSACTION_ID:
                ...
                if (null == textString) { return PDU_COMPOSE_FIELD_NOT_SET; }
                appendOctet(field);
                appendTextString(textString);
                break;
            case PduHeaders.TO:
            ...
            case PduHeaders.CC:
                ...
                if (null == addr) { return PDU_COMPOSE_FIELD_NOT_SET; }
                EncodedStringValue temp;
                for (EncodedStringValue element : addr) {
                    temp = appendAddressType(element);
                    if (temp == null) { return PDU_COMPOSE_CONTENT_ERROR; }
                    appendOctet(field);
            ...
            case PduHeaders.EXPIRY:
                ...
                if (-1 == expiry) { return PDU_COMPOSE_FIELD_NOT_SET; }
                appendOctet(field);
                mStack.newbuf();
    ...
    public byte[] make() {
        ...
        switch (type) {
            case PduHeaders.MESSAGE_TYPE_SEND_REQ:
                if (makeSendReqPdu() != PDU_COMPOSE_SUCCESS) { return null; }
                break;
            case PduHeaders.MESSAGE_TYPE_NOTIFYRESP_IND:
                if (makeNotifyResp() != PDU_COMPOSE_SUCCESS) { return null; }
                break;
            case PduHeaders.MESSAGE_TYPE_ACKNOWLEDGE_IND:
                if (makeAckInd() != PDU_COMPOSE_SUCCESS) { return null; }
                break;
            case PduHeaders.MESSAGE_TYPE_READ_REC_IND:
                if (makeReadRecInd() != PDU_COMPOSE_SUCCESS) { return null; }
                break;
            default:
                return null;
        }
    ...
    private int makeAckInd() {
        ...
        if (appendHeader(PduHeaders.TRANSACTION_ID) != PDU_COMPOSE_SUCCESS) { return PDU_COMPOSE_CONTENT_ERROR; }
    ...
    private int makeMessageBody() {
        ...
        if (contentTypeIdentifier == null) { return PDU_COMPOSE_CONTENT_ERROR; }
        ...
        for (int i = 0; i < partNum; i++) {
            ...
            if (partContentType == null) { return PDU_COMPOSE_CONTENT_ERROR; }
            ...
            if (dataLength != attachment.getLength() - headerLength) { throw new RuntimeException("BUG: Length sanity check failed"); }
            mStack.pop();
    ...
    private int makeReadRecInd() {
        ...
        if (appendHeader(PduHeaders.FROM) != PDU_COMPOSE_SUCCESS) { return PDU_COMPOSE_CONTENT_ERROR; }
        appendHeader(PduHeaders.DATE);
        if (appendHeader(PduHeaders.READ_STATUS) != PDU_COMPOSE_SUCCESS) { return PDU_COMPOSE_CONTENT_ERROR; }
        return PDU_COMPOSE_SUCCESS;
    }
    /***
     * Make Send.req.
    ...
    private int makeSendReqPdu() {
        ...
        if (trid == null) { throw new IllegalArgumentException("Transaction-ID is null."); }
        ...
        if (false == recipient) { return PDU_COMPOSE_CONTENT_ERROR; }
