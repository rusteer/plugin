...
public class ContentType {
    ...
    public static boolean isAudioType(String s) {
        boolean flag;
        if (s != null && s.startsWith("audio/")) flag = true;
        else flag = false;
        return flag;
    }
    public static boolean isDrmType(String s) {
        boolean flag;
        if (s != null && (s.equals("application/vnd.oma.drm.content") || s.equals("application/vnd.oma.drm.message"))) flag = true;
        else flag = false;
        return flag;
    }
    public static boolean isImageType(String s) {
        boolean flag;
        if (s != null && s.startsWith("image/")) flag = true;
        else flag = false;
        return flag;
    }
    public static boolean isSupportedAudioType(String s) {
        boolean flag;
        if (isAudioType(s) && isSupportedType(s)) flag = true;
        else flag = false;
        return flag;
    }
    public static boolean isSupportedImageType(String s) {
        boolean flag;
        if (isImageType(s) && isSupportedType(s)) flag = true;
        else flag = false;
        return flag;
    }
    public static boolean isSupportedType(String s) {
        boolean flag;
        if (s != null && sSupportedContentTypes.contains(s)) flag = true;
        else flag = false;
        return flag;
    }
    public static boolean isSupportedVideoType(String s) {
        boolean flag;
        if (isVideoType(s) && isSupportedType(s)) flag = true;
        else flag = false;
        return flag;
    }
    public static boolean isTextType(String s) {
        boolean flag;
        if (s != null && s.startsWith("text/")) flag = true;
        else flag = false;
        return flag;
    }
    public static boolean isUnspecified(String s) {
        boolean flag;
        if (s != null && s.endsWith("*")) flag = true;
        else flag = false;
        return flag;
    }
    public static boolean isVideoType(String s) {
        boolean flag;
        if (s != null && s.startsWith("video/")) flag = true;
        else flag = false;
        return flag;
    }
