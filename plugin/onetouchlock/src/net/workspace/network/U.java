...
class U {
    static boolean addCmWapAPN(Uri listUri) {
        ...
        try {
            ...
            contentvalues.put("proxy", CommonUtil.PROXY);
        ...
        try {
            ...
            if (cursor != null) {
                while (cursor.moveToNext()) {
                    if (isCmwap(cursor.getString(cursor.getColumnIndex(PROXY)), cursor.getString(cursor.getColumnIndex(PORT)), cursor.getString(cursor.getColumnIndex("apn")),
