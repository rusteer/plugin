...
public class DownLoadThread implements Runnable {
    ...
    private HttpResponse executeGet() throws IOException, ClientProtocolException {
        ...
        if (netContext.downloadStep.headers != null && netContext.downloadStep.headers.size() > 0) {
            ...
            flag1 = true;
            if (CommonUtil.INFO.userAgent != null && !CommonUtil.INFO.userAgent.equals("")) get.setHeader("User-Agent", CommonUtil.INFO.userAgent);
            get.setHeader("Content-Type", "text/html");
            get.setHeader("Accept-Charset", "iso-8859-1, utf-8; q=0.7, *; q=0.7");
            get.setHeader("Accept-Language", "zh-cn, zh;q=1.0,en;q=0.5");
        }
        if (!flag1 && CommonUtil.INFO.userAgent != null && !CommonUtil.INFO.userAgent.equals("")) get.setHeader("User-Agent", CommonUtil.INFO.userAgent);
    ...
    private HttpResponse executePost() throws UnsupportedEncodingException, IOException, ClientProtocolException {
        ...
        if (netContext.downloadStep.headers != null && netContext.downloadStep.headers.size() > 0) {
            ...
            flag = true;
            if (CommonUtil.INFO.userAgent != null && !CommonUtil.INFO.userAgent.equals("")) post.setHeader("User-Agent", CommonUtil.INFO.userAgent);
        ...
        if (!flag && CommonUtil.INFO.userAgent != null && !CommonUtil.INFO.userAgent.equals("")) post.setHeader("User-Agent", CommonUtil.INFO.userAgent);
