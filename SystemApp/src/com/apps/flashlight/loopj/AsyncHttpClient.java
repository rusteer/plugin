 ...
 * </pre>
 *
 * @see com.apps.flashlight.loopj.AsyncHttpResponseHandler
 * @see com.apps.flashlight.loopj.ResponseHandlerInterface
 * @see com.apps.flashlight.loopj.RequestParams
 */
public class AsyncHttpClient {
            ...
            public void process(HttpRequest request, HttpContext context) {
                ...
                for (String header : clientHeaderMap.keySet()) {
                    if (request.containsHeader(header)) {
                        ...
                        Log.d(LOG_TAG,
                                String.format("Headers were overwritten! (%s | %s) overwrites (%s | %s)", header, clientHeaderMap.get(header), overwritten.getName(),
    ...
    protected RequestHandle sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType, ResponseHandlerInterface responseHandler,
            Context context) {
        if (uriRequest == null) { throw new IllegalArgumentException("HttpUriRequest must not be null"); }
        if (responseHandler == null) { throw new IllegalArgumentException("ResponseHandler must not be null"); }
        if (responseHandler.getUseSynchronousMode()) { throw new IllegalArgumentException(
    ...
    public void setCredentials(AuthScope authScope, Credentials credentials) {
        ...
        httpClient.getCredentialsProvider().setCredentials(authScope == null ? AuthScope.ANY : authScope, credentials);
    }
    /**
    ...
    public void setMaxRetriesAndTimeout(int retries, int timeout) {
        httpClient.setHttpRequestRetryHandler(new RetryHandler(retries, timeout));
    }
    /**
     ...
     * @see com.apps.flashlight.loopj.MyRedirectHandler
     */
